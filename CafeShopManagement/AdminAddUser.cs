...
namespace CafeShopManagement
{
    public partial class AdminAddUser : UserControl
    {
        ...
        private void adminAddUers_importBtn_Click(object sender, EventArgs e)
        {
        ...
        private void adminAddUers_addBtn_Click(object sender, EventArgs e)
        {
            if (emptyFields())
            {
        ...
        private void adminAddUers_importBtn_Click_1(object sender, EventArgs e)
        {
            try
            {
        ...
        private void adminAddUers_updateBtn_Click(object sender, EventArgs e)
        {
            if (emptyFields())
            {
                MessageBox.Show("All fields are required to be filled.", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void adminAddUers_clearBtn_Click(object sender, EventArgs e)
        {
            clearFields();
        }

        private void adminAddUers_deleteBtn_Click(object sender, EventArgs e)
        {
            if (emptyFields())
            {
                MessageBox.Show("All fields are required to be filled.", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                if (result == DialogResult.Yes)
                {
                    if (connect.State != ConnectionState.Open)
                    {
                        try
                        {
                            ...
                            string deleteData = "UPDATE users SET status = 'Inactive' WHERE id = @id";
